...
public class RewardRevealEffect {
     ...
     */
    public static void play(CombatLogPlugin plugin, Player player, ItemStack item) {
     ...
     */
    public static void playLight(CombatLogPlugin plugin, Player player, ItemStack item) {
        if (!player.isOnline() || item == null) {
            return;
        }
    ...
    private static void animate(CombatLogPlugin plugin, Player player, Location anchor, ItemDisplay display,
    ...
    private static void spinOnly(CombatLogPlugin plugin, ItemDisplay display, long start, int ticksLeft) {
        if (!display.isValid()) {
            return;
        }
        long elapsed = System.currentTimeMillis() - start;
